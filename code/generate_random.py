...
def main():
    ...
    N_rand_try = 10000
    ra_rand, _ = generate_and_subsample(NSIDE_map, rng, ra_data, dec_data, fn_map)
    ...
    ra_rand, dec_rand = generate_and_subsample(NSIDE_map, rng, ra_data, dec_data, fn_map)
...
def generate_and_subsample(NSIDE_map, rng, ra_rand, dec_rand, fn_map):
    map_p = hp.read_map(fn_map)
    _, pixel_indices_rand = maps.get_map(NSIDE_map, ra_rand, dec_rand)
