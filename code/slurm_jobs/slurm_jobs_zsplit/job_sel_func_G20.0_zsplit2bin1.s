#!/bin/bash
#SBATCH --job-name=sel_func_G20.0_zsplit2bin1
...
python selection_function_map.py ../data/quaia_G20.0_zsplit2bin1.fits ../data/maps/selection_function_NSIDE64_G20.0_zsplit2bin1.fits -p ../data/quaia_G20.0.fits;
"
