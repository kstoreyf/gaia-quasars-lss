#!/bin/bash
#SBATCH --job-name=sel_func_G20.5_zsplit4bin2
...
python selection_function_map.py ../data/quaia_G20.5_zsplit4bin2.fits ../data/maps/selection_function_NSIDE64_G20.5_zsplit4bin2.fits -p ../data/quaia_G20.5.fits;
"
